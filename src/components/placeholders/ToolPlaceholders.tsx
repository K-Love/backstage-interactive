// SEO Analyzer Placeholder
export const SeoAnalyzerPlaceholder = () => (
    <svg width="800" height="600" viewBox="0 0 800 600" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="400" y="200" textAnchor="middle" fill="#2E3192" fontSize="24" fontFamily="system-ui">
        SEO Analyzer
      </text>
    </svg>
  );
  ...
  export const ContentGeneratorPlaceholder = () => (
    <svg width="800" height="600" viewBox="0 0 800 600" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="800" height="600" fill="#F8FAFC"/>
      ...
      <text x="400" y="150" textAnchor="middle" fill="#2E3192" fontSize="24" fontFamily="system-ui">
        Content Generator
      </text>
    </svg>
  );
  ...
  export const AnalyticsDashboardPlaceholder = () => (
    <svg width="800" height="600" viewBox="0 0 800 600" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="800" height="600" fill="#F8FAFC"/>
